      ...
      <header className="border-b border-[#222222] py-4">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <span className="text-sm">1.243 fãs online</span>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 container mx-auto px-4 py-6 flex flex-col md:flex-row gap-6">
          ...
          <Tabs defaultValue="chat" className="w-full">
            ...
            <TabsContent value="community" className="mt-0">
              <div className="bg-[#111111] rounded-lg border border-[#222222] p-4">
                ...
                <Button className="w-full bg-[#00FF00] text-black hover:bg-[#00CC00]">Entrar na Comunidade Discord</Button>
              </div>
            </TabsContent>
          </Tabs>
        </div>
        ...
        <div className="flex-1 bg-[#111111] rounded-lg border border-[#222222] flex flex-col">
          <div className="p-4 border-b border-[#222222]">
            ...
            <p className="text-sm text-gray-400">Converse com outros fãs e receba as últimas atualizações</p>
          </div>
