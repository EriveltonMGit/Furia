...
export function DocumentUploader({
  ...
  const handleVerifyDocuments = async () => {
    ...
    try {
      ...
      // Usar o UID do usuário autenticado em vez de um ID hardcoded
      ...
      // Se a verificação for bem-sucedida, atualizar o status para "verified"
      if (result.faceVerified) {
        try {
          // Assuming updateVerificationStatus is defined elsewhere and accessible
          // await updateVerificationStatus(userId, {
          //     status: "verified",
          //     faceVerified: true,
          //     confidence: result.confidence,
          // });
          console.log("Status de verificação atualizado com sucesso para o usuário:", userId)
        } catch (updateError) {
