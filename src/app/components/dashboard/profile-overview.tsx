...
import { Award, Calendar, CheckCircle2, Clock, Copy, Star, User } from "lucide-react"
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Progress value={mergedData.profileCompletion} className="h-2" />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge
                  className={
                    mergedData.user?.verification_status === "verified" || mergedData.user?.face_verified === true
                      ? "bg-green-600"
                      : mergedData.user?.verification_status === "pending"
                        ? "bg-yellow-600"
                        : mergedData.user?.verification_status === "rejected"
                          ? "bg-red-600"
                          : "bg-gray-600" // Para unverified
                  }
                >
                  {mergedData.user?.verification_status === "verified" || mergedData.user?.face_verified === true ? (
                    <>
              ...
              {/* Adicionar detalhes da verificação se o usuário estiver verificado */}
              {(mergedData.user?.verification_status === "verified" || mergedData.user?.face_verified === true) && (
                <div className="mt-2 text-xs text-gray-400 space-y-1">
                  <div className="flex justify-between">
                    <span>Confiança:</span>
                    <span>
                      {mergedData.user?.verification_confidence
                        ? `${(mergedData.user.verification_confidence * 100).toFixed(0)}%`
                        : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span>Verificado em:</span>
                    <span>{formatTimestampOrDateString(mergedData.user?.verification_date)}</span>
                  </div>
                </div>
              )}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                {mergedData.interests?.favoriteGames?.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {mergedData.interests.favoriteGames.map(
                      (
                        game:
                          | string
                          | number
              ...
              <div>
                ...
                {mergedData.interests?.favoriteTeams?.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {mergedData.interests.favoriteTeams.map(
                      (
                        team:
                          | string
                          | number
              ...
              <div>
                ...
                {mergedData.interests?.followedPlayers?.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {mergedData.interests.followedPlayers.map(
                      (
                        player:
                          | string
                          | number
              ...
              <div>
                ...
                {mergedData.interests?.preferredPlatforms?.length > 0 ? (
                  <div className="flex flex-wrap gap-2">
                    {mergedData.interests.preferredPlatforms.map(
                      (
                        platform:
                          | string
                          | number
                  ...
                  return (
                    <div key={act.id} className="flex items-start space-x-3">
                      <div className="mt-0.5">
                        {act.type === "event" && <Calendar className="h-4 w-4 text-blue-400" />}
                        {act.type === "purchase" && <Award className="h-4 w-4 text-green-400" />}
                        {act.type === "social" && <User className="h-4 w-4 text-purple-400" />}
                      </div>
                      <div>
